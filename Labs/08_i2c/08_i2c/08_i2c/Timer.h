...
#define TIM0_overflow_interrupt_disable () TIMSK1 &= ~(1<<TOIE0);
...
#define TIM2_overflow_16us() TCCR1B &= ~((1<<CS22) | (1<<CS21)); TCCR2B |= (1<<CS20);
#define TIM2_overflow_128us() TCCR1B &= ~((1<<CS22) | (1<<CS20)); TCCR1B |= (1<<CS21);
#define TIM2_overflow_512us() TCCR1B &= ~(1<<CS22); TCCR2B |= (1<<CS21)| (1<<CS20);
#define TIM2_overflow_1ms() TCCR1B &= ~((1<<CS21) | (1<<CS20)); TCCR2B |= (1<<CS22);
#define TIM2_overflow_2ms() TCCR1B &= ~(1<<CS21); TCCR2B |= (1<<CS22)| (1<<CS20);
#define TIM2_overflow_4ms() TCCR1B &= ~(1<<CS20); TCCR2B |= (1<<CS22)| (1<<CS21);
#define TIM2_overflow_16ms() TCCR1B |= (1<<CS21) | (1<<CS22) | (1<<CS20);
/**
